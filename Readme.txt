Source code for the paper: Dirichlet Process Mixture Model for Correcting Technical Variation in Single-Cell Gene Expression Data by Sandhya Prabhakaran*, Elham Azizi*, Ambrose J Carr, and Dana Pe’er in ICML 2016. 
Download paper from: http://jmlr.org/proceedings/papers/v48/prabhakaran16.pdf
...
4. At the R prompt: Issue command ‘source(“start_file.R”)’. 

Output
______

1. Output folder gets created which has the MCMC runs logged in log.txt and log_CM.txt files. For resolving any discrepancies while parallel processing of your data, check debug.txt and debug_CM.txt.
